...
Widget buildPopular(BuildContext context) {
  return FutureBuilder(
    future: FirebaseFirestore.instance.collection('food').get(), // Fetch data from Firestore
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            '${doc['typefood']}', // Assuming 'price' is the field in your Firestore document containing the coffee price
